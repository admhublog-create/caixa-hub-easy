...
export function TapePage(){
 ...
 async function load(){if(!supabase)return;const[r,e,i,ih,p]=await Promise.all([
 ...
 ]);setR((r.data||[]) as R[]);setE((e.data||[]) as E[]);setInv((i.data?.[0]||null) as I|null);setInventories((ih.data||[]) as I[]);setPurchases((p.data||[]) as P[])}
 useEffect(()=>{load()},[]);
