...
export function TapePage(){
 ...
 const[boxes,setBoxes]=useState("0"),[rolls,setRolls]=useState("0"),[kg,setKg]=useState(""),[value,setValue]=useState(""),[supplier,setSupplier]=useState(""),[note,setNote]=useState(""),[msg,setMsg]=useState(""),[adding,setAdding]=useState(false),[loadError,setLoadError]=useState("");
