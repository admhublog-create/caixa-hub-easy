...
export function TapePage(){
 ...
 return <><div className="mb-6"><h2 className="text-2xl font-bold">Fita Gomada</h2><p className="text-sm text-[var(--muted)]">Controle de estoque físico. 1 caixa = 15 rolos.</p></div>
